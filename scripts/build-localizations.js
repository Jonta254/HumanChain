/**
 * Builds the full World Developer Portal description JSON
 * with localisations for all 13 supported languages.
 *
 * Run: node scripts/build-localizations.js
 * Output: prints the JSON string to stdout.
 */
...
const localisations = [
  ...
  // ── Hindi ────────────────────────────────────────────────────────────
  {
    ...
    description_how_it_works:
      "अपने World ID वॉलेट से एक बार साइन इन करें। आपका सत्यापन तुरंत सभी पाँच मुख्य सुविधाओं को अनलॉक करता है:\n\nपूछें — वैश्विक सत्यापित-मानव समुदाय को प्रश्न पोस्ट करें। दैनिक प्रश्न का उत्तर दें और +18 HP कमाएँ। हर उत्तर एक अनूठी, वास्तविक मानव पहचान से जुड़ा है।\n\nपल — अपने सत्यापित उपयोगकर्ता नाम के साथ फोटो-पहले के पोस्ट साझा करें। कोई गुमनाम पोस्ट नहीं।\n\nबाज़ार — तीन फोटो, स्थिति नोट्स और निश्चित WLD मूल्य के साथ वस्तुएँ सूचीबद्ध करें। खरीदार मुफ्त में ब्राउज़ करते हैं। विक्रेता प्रकाशित करने या बूस्ट करने के लिए एक छोटी WLD शुल्क देते हैं।\n\nकहानियाँ — पहचान, प्रवास, आस्था, धन, प्रेम और उद्देश्य पर वास्तविक सत्यापित मनुष्यों द्वारा लिखी गई मासिक क्यूरेटेड कहानियाँ पढ़ें।\n\nपासपोर्ट — अपने मानव स्कोर, स्ट्रीक, HP लेज़र, व्यापार इतिहास और बैज को एक लाइव ट्रस्ट पहचान में ट्रैक करें। अन्य मनुष्यों को आमंत्रित करने और प्रत्येक सत्यापित जुड़ाव पर +50 HP कमाने के लिए अपना रेफरल लिंक साझा करें।",
    description_connect:
      "HumanChain किसी भी सार्वजनिक कार्य की अनुमति से पहले प्रत्येक उपयोगकर्ता को एक अनूठे, वास्तविक मानव के रूप में सत्यापित करने के लिए World ID Sign-In with Ethereum (SIWE) का उपयोग करता है। कोई बॉट नहीं। कोई डुप्लिकेट खाता नहीं।\n\nआपका वॉलेट पता कभी भी सार्वजनिक रूप से प्रदर्शित नहीं होता — केवल आपका World उपयोगकर्ता नाम प्रश्नों, कहानियों, मार्केटप्लेस लिस्टिंग और चेन लिंक में दिखाई देता है। आप किसी भी समय World App सेटिंग से HumanChain की पहुँच रद्द कर सकते हैं।\n\nWLD भुगतान World App के मूल भुगतान प्रणाली के माध्यम से संसाधित किए जाते हैं। सूचनाएँ केवल कार्यात्मक हैं: दैनिक प्रश्न रिमाइंडर, मार्केटप्लेस बोली अलर्ट, स्वीकृत ऑफर सूचनाएँ, भुगतान पुष्टि और खाता सुरक्षा अलर्ट।",
  },
  ...
  // ── Indonesian ───────────────────────────────────────────────────────
  {
    ...
    description_how_it_works:
      "Masuk sekali dengan dompet World ID Anda. Verifikasi Anda langsung membuka semua lima fitur utama:\n\nTANYA — Posting pertanyaan ke komunitas manusia terverifikasi global. Jawab pertanyaan harian untuk mendapatkan +18 HP. Setiap jawaban terkait dengan identitas manusia nyata yang unik.\n\nMOMEN — Bagikan postingan berbasis foto dengan nama pengguna terverifikasi Anda. Tidak ada postingan anonim.\n\nPASAR — Daftarkan barang dengan tiga foto, catatan kondisi, dan harga WLD tetap. Pembeli menjelajah gratis. Penjual membayar biaya WLD kecil untuk menerbitkan atau meningkatkan.\n\nCERITA — Baca cerita bulanan yang dikurasi dan ditulis oleh manusia terverifikasi tentang identitas, migrasi, iman, uang, cinta, dan tujuan.\n\nPASPOR — Lacak Skor Manusia, streak, buku HP, riwayat perdagangan, dan lencana Anda dalam satu identitas kepercayaan langsung. Bagikan tautan referral Anda untuk mengundang manusia lain dan mendapatkan +50 HP per bergabung yang terverifikasi.",
    description_connect:
      "HumanChain menggunakan World ID Sign-In with Ethereum (SIWE) untuk memverifikasi bahwa setiap pengguna adalah manusia unik dan nyata sebelum tindakan publik apa pun diizinkan. Tidak ada bot. Tidak ada akun duplikat.\n\nAlamat dompet Anda tidak pernah ditampilkan secara publik — hanya nama pengguna World Anda yang muncul di pertanyaan, cerita, daftar marketplace, dan tautan rantai. Anda dapat mencabut akses HumanChain dari pengaturan World App kapan saja.\n\nPembayaran WLD diproses melalui sistem pembayaran asli World App. Notifikasi hanya bersifat fungsional: pengingat pertanyaan harian, peringatan tawaran, notifikasi penawaran yang diterima, peluncuran cerita, konfirmasi pembayaran, dan peringatan keamanan akun.",
  },
  ...
  // ── German ───────────────────────────────────────────────────────────
  {
    ...
    world_app_description:
      "Das einzige soziale Netzwerk, in dem jeder Nutzer ein verifizierter echter Mensch ist. Fragen, posten, handeln und Ihren Vertrauenspass aufbauen — in World App.",
    description_overview:
    ...
    description_how_it_works:
      "Melden Sie sich einmal mit Ihrer World ID-Wallet an. Ihre Verifizierung schaltet sofort alle fünf Kernfunktionen frei:\n\nFRAGEN — Stellen Sie Fragen an die globale Gemeinschaft verifizierter Menschen. Beantworten Sie die tägliche Frage, um +18 HP zu verdienen. Jede Antwort ist mit einer einzigartigen, echten menschlichen Identität verknüpft.\n\nMOMENTE — Teilen Sie fotobasierte Beiträge mit Ihrem verifizierten Benutzernamen. Keine anonymen Beiträge.\n\nMARKT — Listen Sie Artikel mit drei Fotos, Zustandsnotizen und einem festen WLD-Preis auf. Käufer können kostenlos stöbern. Verkäufer zahlen eine kleine WLD-Gebühr zum Veröffentlichen oder Boosten.\n\nGESCHICHTEN — Lesen Sie monatlich kuratierte Geschichten von echten verifizierten Menschen über Identität, Migration, Glauben, Geld, Liebe und Zweck.\n\nPASS — Verfolgen Sie Ihren Menschenwert, Serie, HP-Buch, Handelshistorie und Abzeichen in einer Live-Vertrauensidentität. Teilen Sie Ihren Empfehlungslink, um andere Menschen einzuladen und +50 HP pro verifiziertem Beitritt zu verdienen.",
    description_connect:
      "HumanChain verwendet World ID Sign-In with Ethereum (SIWE), um zu verifizieren, dass jeder Nutzer ein einzigartiger, echter Mensch ist, bevor öffentliche Aktionen erlaubt werden. Keine Bots. Keine doppelten Konten.\n\nIhre Wallet-Adresse wird niemals öffentlich angezeigt — nur Ihr World-Benutzername erscheint in Fragen, Geschichten, Marktplatz-Listings und Chain-Links. Sie können den Zugriff von HumanChain jederzeit in den World App-Einstellungen widerrufen.\n\nWLD-Zahlungen werden über das native Zahlungssystem von World App verarbeitet. Benachrichtigungen sind ausschließlich funktional: tägliche Frageerinnerungen, Marktplatz-Gebotsbenachrichtigungen, angenommene Angebote, Story-Veröffentlichungen, Zahlungsbestätigungen und Kontosicherheitsbenachrichtigungen.",
  },
  ...
  // ── Turkish ──────────────────────────────────────────────────────────
  {
    ...
    description_overview:
      "HumanChain, yalnızca World App içinde inşa edilmiş doğrulanmış insanlar için bir sosyal ağdır. Her kullanıcı, World ID aracılığıyla benzersiz ve gerçek bir kişi olarak onaylanır — bu da onu botların, sahte hesapların ve çift kimliklerin yapısal olarak imkânsız olduğu ilk platform yapar.\n\nGerçek sorular sorun ve dünya çapındaki doğrulanmış insanlardan yanıtlar alın. Doğrulanmış kimliğinizle bağlantılı fotoğraf odaklı anlar paylaşın. WLD ödemeleriyle desteklenen güven odaklı bir pazar aracılığıyla yakındaki ürünleri alın ve satın. Aylık olarak seçilmiş insan hikayelerini okuyun. İnsan Pasaportunuzu oluşturun — canlı bir güven puanı, seri, rozet geçmişi, HP puanları ve her dürüst eylemle büyüyen bir itibar kaydı.\n\nHumanChain 13 dilde mevcut olup 180'den fazla ülkedeki doğrulanmış insanlara hizmet eder.",
    description_how_it_works:
      "World ID cüzdanınızla bir kez giriş yapın. Doğrulamanız anında beş temel özelliği açar:\n\nSOR — Küresel doğrulanmış insan topluluğuna sorular gönderin. Günlük soruyu yanıtlayarak +18 HP kazanın. Her yanıt, benzersiz ve gerçek bir insan kimliğiyle bağlantılıdır.\n\nANLAR — Doğrulanmış kullanıcı adınızla fotoğraf odaklı gönderiler paylaşın. Anonim gönderi yoktur.\n\nPAZAR — Üç fotoğraf, durum notları ve sabit WLD fiyatıyla ürünleri listeleyin. Alıcılar ücretsiz gezinir. Satıcılar yayınlamak veya öne çıkarmak için küçük bir WLD ücreti öder.\n\nHİKAYELER — Kimlik, göç, inanç, para, aşk ve amaç üzerine gerçek doğrulanmış insanlar tarafından yazılmış aylık seçilmiş hikayeleri okuyun.\n\nPASAPORT — İnsan Puanınızı, serinizi, HP defterinizi, ticaret geçmişinizi ve rozetlerinizi canlı bir güven kimliğinde takip edin. Diğer insanları davet etmek ve her doğrulanmış katılım için +50 HP kazanmak için tavsiye bağlantınızı paylaşın.",
    description_connect:
      "HumanChain, herhangi bir kamuya açık eyleme izin verilmeden önce her kullanıcının benzersiz ve gerçek bir insan olduğunu doğrulamak için World ID Sign-In with Ethereum (SIWE) kullanır. Bot yok. Çift hesap yok.\n\nCüzdan adresiniz hiçbir zaman herkese açık olarak görüntülenmez — yalnızca World kullanıcı adınız sorular, hikayeler, pazar listeleri ve zincir bağlantılarında görünür. World App ayarlarından istediğiniz zaman HumanChain erişimini iptal edebilirsiniz.\n\nWLD ödemeleri, World App'in yerel ödeme sistemi aracılığıyla işlenir. Bildirimler yalnızca işlevseldir: günlük soru hatırlatıcıları, pazar teklifi uyarıları, kabul edilen teklif bildirimleri, hikaye yayınları, ödeme onayları ve hesap güvenliği uyarıları.",
  },
  ...
  // ── Japanese ─────────────────────────────────────────────────────────
  {
    ...
    description_overview:
      "HumanChainは、World App内に構築された認証済み人間向けソーシャルネットワークです。すべてのユーザーはWorld IDを通じて唯一の実在の人物として確認されており、ボット、偽アカウント、重複アイデンティティが構造的に不可能な初めてのプラットフォームです。\n\n本物の質問をして、世界中の認証済み人間から回答を受け取りましょう。認証済みアイデンティティに紐づいた写真優先の投稿を共有しましょう。WLD決済を使った信頼優先のマーケットプレイスで近くのアイテムを売買しましょう。毎月キュレートされた人間のストーリーを読みましょう。ヒューマンパスポートを構築しましょう — リアルタイムの信頼スコア、ストリーク、バッジ履歴、HPポイント、そして誠実な行動のたびに成長する評判記録。\n\nHumanChainは13言語で利用可能で、180以上の国々の認証済み人間にサービスを提供しています。",
    description_how_it_works:
      "World IDウォレットで一度サインインしてください。認証により、5つのコア機能が即座にアンロックされます：\n\n質問 — グローバルな認証済み人間コミュニティに質問を投稿してください。毎日の質問に答えて+18 HPを獲得しましょう。すべての回答は唯一の本物の人間アイデンティティに紐づいています。\n\nモーメント — 認証済みユーザー名で写真優先の投稿を共有しましょう。匿名投稿はありません。\n\nマーケット — 3枚の写真、状態メモ、固定WLD価格でアイテムをリスト登録しましょう。購入者は無料で閲覧できます。販売者は公開またはブーストのために少額のWLD手数料を支払います。\n\nストーリー — アイデンティティ、移住、信仰、お金、愛、目的についての本物の認証済み人間が書いた毎月キュレートされたストーリーを読みましょう。\n\nパスポート — ヒューマンスコア、ストリーク、HPレジャー、取引履歴、バッジをライブ信頼アイデンティティとして追跡しましょう。紹介リンクを共有して他の人間を招待し、認証済み参加ごとに+50 HPを獲得しましょう。",
    description_connect:
      "HumanChainは、公開アクションが許可される前にすべてのユーザーが唯一の本物の人間であることを確認するために、World ID Sign-In with Ethereum（SIWE）を使用します。ボットなし。重複アカウントなし。\n\nウォレットアドレスは公開されることはありません — 質問、ストーリー、マーケットプレイスリスティング、チェーンリンクにはWorldユーザー名のみが表示されます。いつでもWorld Appの設定からHumanChainのアクセスを取り消すことができます。\n\nWLD決済はWorld Appのネイティブ決済システムを通じて処理されます。通知は機能的なもののみです：毎日の質問リマインダー、マーケットプレイス入札アラート、承諾されたオファー通知、ストーリーリリース、決済確認、アカウントセキュリティアラート。",
  },
  ...
  // ── Chinese Simplified ───────────────────────────────────────────────
  {
    ...
    description_how_it_works:
      "使用您的World ID钱包登录一次，验证即可立即解锁五项核心功能：\n\n提问——向全球认证人类社区发布问题。回答每日问题获得+18 HP，并将您的回答纳入全球世界裁决。每个回答都与唯一的真实人类身份绑定。\n\n动态——使用您的认证用户名分享照片优先帖子。无匿名发帖。\n\n市场——以三张照片、状态备注和固定WLD价格上架商品。买家免费浏览。卖家支付少量WLD费用进行发布或推广。\n\n故事——阅读由真实认证人类撰写的关于身份、移民、信仰、金钱、爱情和目的的每月精选故事。\n\n护照——在一个实时信任身份中跟踪您的人类评分、连续打卡、HP账本、交易历史和徽章。分享您的推荐链接邀请其他人类加入，每次认证加入可获得+50 HP。",
    description_connect:
      "HumanChain使用World ID Sign-In with Ethereum（SIWE）验证每位用户在允许任何公开操作之前都是唯一的真实人类。无机器人。无重复账户。\n\n您的钱包地址永远不会公开显示——只有您的World用户名会出现在问题、故事、市场列表和链接中。您可以随时从World App设置中撤销HumanChain的访问权限。\n\nWLD支付通过World App的原生支付系统处理。通知仅限功能性：每日问题提醒、市场出价提醒、已接受报价通知、故事发布、支付确认和账户安全提醒。",
  },
  ...
  // ── Korean ───────────────────────────────────────────────────────────
  {
    ...
    description_overview:
      "HumanChain은 World App 내에서만 구축된 검증된 인간 소셜 네트워크입니다. 모든 사용자는 World ID를 통해 고유하고 실제 사람임이 확인됩니다 — 봇, 가짜 계정, 중복 신원이 구조적으로 불가능한 최초의 플랫폼입니다.\n\n실제 질문을 하고 전 세계 검증된 인간들로부터 답변을 받으세요. 검증된 신원과 연결된 사진 중심 순간을 공유하세요. WLD 결제로 구동되는 신뢰 우선 마켓플레이스를 통해 근처 물건을 사고파세요. 매월 큐레이션된 인간 이야기를 읽으세요. 인간 여권을 만드세요 — 실시간 신뢰 점수, 스트릭, 배지 기록, HP 포인트, 모든 정직한 행동과 함께 성장하는 평판 기록.\n\nHumanChain은 13개 언어로 제공되며 180개 이상의 국가에서 검증된 인간들에게 서비스를 제공합니다.",
    description_how_it_works:
      "World ID 지갑으로 한 번 로그인하세요. 인증하면 5가지 핵심 기능이 즉시 잠금 해제됩니다:\n\n질문 — 글로벌 검증 인간 커뮤니티에 질문을 게시하세요. 매일 질문에 답변하여 +18 HP를 획득하세요. 모든 답변은 고유하고 실제 인간 신원과 연결됩니다.\n\n모먼트 — 검증된 사용자 이름으로 사진 중심 게시물을 공유하세요. 익명 게시물이 없습니다.\n\n마켓 — 세 장의 사진, 상태 메모, 고정 WLD 가격으로 물건을 등록하세요. 구매자는 무료로 탐색합니다. 판매자는 게시 또는 부스트를 위해 소액의 WLD 수수료를 지불합니다.\n\n스토리 — 신원, 이민, 신앙, 돈, 사랑, 목적에 관해 실제 검증된 인간이 쓴 매월 큐레이션된 이야기를 읽으세요.\n\n여권 — 인간 점수, 스트릭, HP 장부, 거래 기록, 배지를 실시간 신뢰 신원으로 추적하세요. 추천 링크를 공유하여 다른 인간을 초대하고 검증된 가입마다 +50 HP를 획득하세요.",
    description_connect:
      "HumanChain은 공개 행동이 허용되기 전에 모든 사용자가 고유하고 실제 인간임을 확인하기 위해 World ID Sign-In with Ethereum(SIWE)을 사용합니다. 봇 없음. 중복 계정 없음.\n\n지갑 주소는 절대 공개적으로 표시되지 않습니다 — 질문, 이야기, 마켓플레이스 목록, 체인 링크에는 World 사용자 이름만 나타납니다. World App 설정에서 언제든지 HumanChain의 접근 권한을 취소할 수 있습니다.\n\nWLD 결제는 World App의 기본 결제 시스템을 통해 처리됩니다. 알림은 기능적인 것만 해당합니다: 일일 질문 알림, 마켓플레이스 입찰 알림, 수락된 제안 알림, 스토리 출시, 결제 확인 및 계정 보안 알림.",
  },
];
...
const descriptionObj = {
  description_overview:
    "HumanChain is a verified-human social network built exclusively inside World App. Every user is confirmed as a unique, real person through World ID — making it the first platform where bots, fake accounts, and duplicate identities are structurally impossible.\n\nAsk real questions and receive answers from verified humans worldwide. Share photo-first moments tied to your verified identity. Buy and sell nearby items through a trust-first marketplace powered by WLD payments. Read curated monthly stories written by real people. Build your Human Passport — a live trust score, streak, badge history, HP points, and reputation record that grows with every honest action you take.\n\nHumanChain is available in 13 languages: English, Spanish, French, Portuguese, Swahili, Arabic, Hindi, Indonesian, German, Turkish, Japanese, Chinese (Simplified), and Korean — serving verified humans across 180+ countries worldwide.",
  description_how_it_works:
    "Sign in once with your World ID wallet. Your verification instantly unlocks all five core features:\n\nASK — Post questions to the global verified-human community. Answer the daily question to earn +18 HP and enter your response into the global World Verdict. Every answer is tied to a real, unique human identity.\n\nMOMENTS — Share photo-first proof-of-life posts with your verified username. React, comment, and follow real verified humans. No anonymous posts.\n\nMARKET — List items for sale with three photos, condition notes, your verified username, and a fixed WLD price. Buyers browse freely. Sellers pay a small WLD fee to publish or boost. Chat-first trade with inspect-before-pay protection.\n\nSTORIES — Read monthly curated stories written by real verified humans on topics ranging from identity to migration, faith, money, love, and purpose.\n\nPASSPORT — Track your Human Score, streak, HP ledger, trade history, safety record, and earned badges — all in one live trust identity. Share your referral link to invite other humans and earn +50 HP per verified join.\n\nEvery action earns Human Points (HP) that build your long-term reputation inside the network.",
  description_connect:
    "HumanChain uses World ID Sign-In with Ethereum (SIWE) to verify every user is a unique, real human before any public action is permitted. No bots. No duplicate accounts. No unverified noise.\n\nYour wallet address is never displayed publicly — only your chosen World username appears across questions, stories, marketplace listings, and chain links. You can revoke HumanChain's access from your World App settings at any time and permanently delete all local data from within the app.\n\nWLD payments are processed through the native World App payment system. HumanChain never handles payment credentials directly. All marketplace transactions include backend payment verification before any confirmation is recorded.\n\nPush notifications are functional-only: daily question reminders, marketplace bid alerts, accepted offer notifications, story drops, payment confirmations, and account safety alerts. You control notification permission from within World App and can disable it at any time.",
  localisations,
};

const json = JSON.stringify(descriptionObj);
console.log(json);
// Also write to a file so we can inspect it
require("fs").writeFileSync(
  require("path").join(__dirname, "..", "scripts", "_localizations.json"),
  JSON.stringify(descriptionObj, null, 2),
  "utf8"
);
console.error("\nJSON length:", json.length, "chars");
console.error("Written to scripts/_localizations.json");
