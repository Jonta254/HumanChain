    ...
    const securityHeaders = [
      ...
      },
      {
        ...
        value: [
          ...
          "font-src 'self' data:",
          "connect-src 'self' https://developer.world.org https://developer.worldcoin.org https://usernames.worldcoin.org https://*.world.org https://world.org https://*.worldcoin.org https://worldcoin.org https://cdn.jsdelivr.net https://cdn.world.org",
